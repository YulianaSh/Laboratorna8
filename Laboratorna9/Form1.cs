...
namespace Laboratorna9
{
    public partial class Form1 : Form
    {
        ...
        public class CaseTransistors
        {
            ...
            // тип транзистора 
            // назва транзистора 
            // назва математичної моделі транзистора 
            // масив для зберігання правильних префіксів імен транзисторів 
            // масив для зберігання транзисторів із модифікатором  
            // доступу private (за замовчуванням) 
            // кількість транзисторів у масиві 
            // код завершення операції записування або читання 
            ...
            public CaseTransistors(int size, string type, string tname, string modelName)
            {
                ...
                Length = size;
                setPrefixName();
                // створюємо масив розміру,який задано у параметрі size  
                // заповнюємо масив структур префіксів імен транзисторів можливими значеннями 
                transType = type;
                transName = tname;
